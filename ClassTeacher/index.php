...
include '../Includes/session.php';
    ...
    $query = "SELECT tblclass.className,tblclassarms.classArmName, firstName, lastName 
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <h1 class="h3 mb-0 text-gray-800">Welcome Teacher <?php echo $rrw['firstName'].' '.$rrw['lastName'];?> !</h1>
          ...
          <h4 class="text-gray-600">Grade <?php echo $rrw['className'].' - '.$rrw['classArmName'];?></h4>
              ...
              <div class="card h-100">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Grade Level</div>
                    ...
                    <div class="col-auto">
                    <i class="fa-solid fa-2x fa-newspaper"></i>
                    </div>
                  </div>
                </div>
              </div>
