            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-secondary">Student Attendance</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        if ($num > 0){
                          ...
                          echo'<option value="'.$rows['admissionNumber'].'" >'.$rows['lastName'].' '.$rows['firstName'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
                        ...
                        <div class="col-xl-3">
                        <label class="form-control-label">Sort Date</label>
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        tblstudents.firstName,tblstudents.lastName,tblstudents.otherName,tblstudents.sex,tblstudents.admissionNumber
                        FROM tblattendance
