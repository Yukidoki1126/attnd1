 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center bg-gradient-secondary justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SMARTA</div>
      </a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAttendance.php">View Section Attendance</a>
            <a class="collapse-item" href="viewStudentAttendance.php">View Student Attendance</a>
            <!-- <a class="collapse-item" href="downloadRecord.php">Reports (xls)</a> -->
