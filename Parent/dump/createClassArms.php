...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
  ...
  if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($conn, "select * from tblclassarms where classArmName ='$classArmName'");
    $ret = mysqli_fetch_array($query);
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-secondary">Add Section</h6>
                    ...
                    <div class="form-group row mb-3">
                      ...
                      <div class="col-xl-5">
                        ...
                        <input type="text" class="form-control" name="classArmName"
                          value="<?php echo $row['classArmName']; ?>" id="exampleInputFirstName" placeholder="Section">
                      </div>
                    </div>
                    <?php
                    if (isset($Id)) {
                          ...
                          if ($num > 0) {
                            while ($rows = $rs->fetch_assoc()) {
                              ...
                              <tr>
                                ...
                                <a onclick='javascript:confirmationDelete($(this));return false;' href='?action=delete&Id=" . $rows['Id'] . "'>Delete</a></td>
                              </tr>";
                            }
                          } else {
                            echo
